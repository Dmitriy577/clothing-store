...
const Store = () => {
  ...
  const showCount = products
    .filter((item) =>
      changeGender === "all" ? item : item.gender === changeGender
    )
  ...
  const showCountsLength = products
    ...
    .filter((el) =>
      categories === "all" ? el : el.category === categories
    ).length;
  ...
  return (
    <section className="store">
      <div className="container">
        ...
        <p className="store__show">
          Показано: {showCount} из {showCountsLength} товаров
        </p>
